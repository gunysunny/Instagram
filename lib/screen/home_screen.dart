...
final feedDataList =[
  FeedData(userName: 'User1', likeCount: 50, content: '오늘 점심은 맛있다.'),
  FeedData(userName: 'User2', likeCount: 40, content: '존맛'),
  FeedData(userName: 'User3', likeCount: 21, content: '맛있다.'),
  FeedData(userName: 'User4', likeCount: 24, content: '저녁머임'),
  FeedData(userName: 'User5', likeCount: 36, content: '뀨'),
  FeedData(userName: 'User6', likeCount: 10, content: '오늘 점심은 맛있다.'),
  FeedData(userName: 'User7', likeCount: 12, content: '오늘 점심은 맛있다.'),
  FeedData(userName: 'User8', likeCount: 48, content: '오늘 점심은 맛있다.'),
  FeedData(userName: 'User9', likeCount: 35, content: '오늘 점심은 맛있다.'),
];
